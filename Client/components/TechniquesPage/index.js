...
export default class TechniquesPage extends Component {
  ...
  componentDidMount() {
    ...
    document.getElementById('wrapper').className =
      document.getElementById('wrapper').className + ' inversed';
  }
  render() {
    return (
      <div className="row row-1 techniques-page">
            ...
            <div className="task row">
              ...
              <div className="col col-md-5  col-lg-5 col-12">
                ...
                <p>
                  ...
                  сравнительно легко, а вот объединение двух составляющих
                  вместе, и переход от одной составляющей упражнения к другой
                  требует определённой силовой и координационной подготовки.
                </p>
              </div>
            </div>
            <div className="task row">
              ...
              <div className="col col-md-5  col-lg-5 col-12">
                ...
                <p>
                  ...
                  должны двигаться; Во время подтягиваний держите локти всегда
                  под перекладиной; В нижней точке траектории полностью
                  распрямите руки.
                </p>
              </div>
            </div>
